...
import {FlashCardDeckComponent} from './components/flash-card-deck/flash-card-deck.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'FlashCard', data: {breadcrumb: 'FlashCard'}, component: FlashCardDeckComponent},
